...
<head>
    ...
    <title>No More Empty Tables</title>
    <style type="text/css">
        /* RESET STYLES */
        html { background-color:#ECF0F1; margin:0; padding:0; }
        ...
        body, #bodyTable{background-color:#ECF0F1;}
        #emailHeader{background-color:#ECF0F1;}
        #emailBody{background-color:#FFFFFF;}
        #emailFooter{background-color:#ECF0F1;}
...
<body bgcolor="#ECF0F1" leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0">
...
-->
<center style="background-color:#ECF0F1;">
    <table border="0" cellpadding="0" cellspacing="0" height="100%" width="100%" id="bodyTable" style="table-layout: fixed;max-width:100% !important;width: 100% !important;min-width: 100% !important;">
        <tr>
            <td align="center" valign="top" id="bodyCell">
                ...
                -->
                <table bgcolor="#ECF0F1" border="0" cellpadding="0" cellspacing="0" width="600" id="emailHeader">
                ...
                <table bgcolor="#ECF0F1" border="0" cellpadding="0" cellspacing="0" width="600" id="emailFooter">
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" bgcolor="#ECF0F1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; {{date('Y',time())}}
                                                                        {{--<a href="https://comoco.it/" target="_blank" style="text-decoration:none;color:#828282;">--}}
                                                                            {{--<span style="color:#828282;">ComoComunica</span>--}}
                                                                        {{--</a>.--}}
                                                                    </div>
                                                                </div>
