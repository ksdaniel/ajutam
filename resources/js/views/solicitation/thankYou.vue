<template>
    <div class="login-container">
        <el-form ref="ruleForm" :model="ruleForm" :rules="rules" class="login-form" auto-complete="on" label-position="top" label-width="120px">
            <h3 class="title">
                Solicitarea a fost procesata cu succes !
            </h3>
            ...
            <!--<el-card>-->
                ...
                <!--<el-form-item label="Cartier" prop="neighborhood">-->
                    <!--<el-input v-model="ruleForm.neighborhood"></el-input>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_10.label" prop="question_10">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_10.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_1.label" prop="question_1">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_1.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_2.label" prop="question_2">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_2.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_3.label" prop="question_3">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_3.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_4.label" prop="question_4">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_4.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_5.label" prop="question_5">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_5.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
                ...
                <!--<el-form-item :label="ruleForm.additional_responses.question_6.label" prop="question_6">-->
                    <!--<el-col :span="24">-->
                        ...
                        <!--<el-input v-model="ruleForm.additional_responses.question_6.answer"></el-input>-->
                    <!--</el-col>-->
                <!--</el-form-item>-->
