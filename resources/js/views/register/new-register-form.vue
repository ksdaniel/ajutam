      ...
      <el-col :xs="24" :md="24" :lg="24">
        ...
        <div v-if="active===0" class="container-form">
          ...
          <div class="buttons-wrapper">
            <el-button type="danger" @click="cancel"><i class="el-icon-error" />Anuleaza</el-button>
        ...
        <div v-if="active===2" class="container-form">
          ...
          <div class="buttons-wrapper">
            <el-button type="danger" @click="cancel"><i class="el-icon-error" />Anuleaza</el-button>
            <el-button type="warning" @click="back"><i class="el-icon-d-arrow-left" />Inapoi</el-button>
            <el-button :disabled="voluteerForm.age_range !=='18-65'" type="success" @click="next('contactForm')">Urmatorul pas<i class="el-icon-d-arrow-right" /></el-button>
          </div>
        </div>
        ...
        <div v-if="(active===4 && voluteerForm.involvement_direction === 'Call Center')" class="container-form">
          ...
          <div class="buttons-wrapper">
            <el-button type="danger" @click="cancel"><i class="el-icon-error" />Anuleaza</el-button>
            <el-button type="warning" @click="back"><i class="el-icon-d-arrow-left" />Inapoi</el-button>
            <el-button type="success" @click="next('dispatcherScreeningForm')">Urmatorul pas <i class="el-icon-d-arrow-right" /></el-button>
          </div>
        </div>

        <div v-if="(active===5 && voluteerForm.involvement_direction === 'Call Center') || (active===6 && voluteerForm.involvement_direction !== 'Call Center')" class="container-form">
        ...
        <div v-if="(active===6 && voluteerForm.involvement_direction === 'Call Center') || (active===7 && voluteerForm.involvement_direction !== 'Call Center')" class="container-form">
        ...
        <div v-if="(active===7 && voluteerForm.involvement_direction === 'Call Center') || (active===8 && voluteerForm.involvement_direction !== 'Call Center')" class="container-form">
        ...
        <div v-if="(active===8 && voluteerForm.involvement_direction === 'Call Center') || (active===9 && voluteerForm.involvement_direction !== 'Call Center')" class="container-form">
        ...
        <div v-if="(active===9 && voluteerForm.involvement_direction === 'Call Center') || (active===10 && voluteerForm.involvement_direction !== 'Call Center' )" class="container-form">
        ...
        <div v-if="(active===10 && voluteerForm.involvement_direction === 'Call Center') || (active===11 && voluteerForm.involvement_direction !== 'Call Center' )" class="container-form">
          ...
          <ul>
            <li>Ești invitat să parcurgi și să studiezi cu atenție detaliile despre ce facem &icirc;n inițiativa Vă ajutăm din Cluj aici: info.civicsuport.ro</li>
            <li>Vei fi contactat de un coordonator. El &icirc;ți va comunica dacă ești admis &icirc;n cadrul echipei Vă ajutăm din Cluj și care sunt următorii pași, adică cei de mai jos, dar cu date la care să te aștepți.</li>
...
export default {
  ...
  mounted(){
    ...
    if (this.volunteer){
      ...
      this.voluteerForm.acord.acordVoluntariat = !!this.volunteer.ip_acord_voluntariat;
